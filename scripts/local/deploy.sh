...
GOOGLE_APPLICATION_CREDENTIALS=/Users/muly/go/src/github.com/research-pal/backend/tmp/research-pal-2-a30e5d878434.json bash -c './research-pal-backend -logmode=DEBUG'
